      ...
      <table width="100%" style="max-width:560px;background:#ffffff;border-radius:12px;overflow:hidden">
        ...
        <tr>
          <td style="padding:32px">
            <h2 style="margin:0 0 8px;font-size:22px;font-weight:700;font-family:'Manrope',-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif;color:#111">Welcome, ${name}!</h2>
