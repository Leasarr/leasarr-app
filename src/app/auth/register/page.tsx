...
function RegisterInner() {
  ...
  const needsInviteCode = !isInvite && role === 'manager'
  ...
  const onSubmit = async (data: RegisterForm) => {
    ...
    // Validate invite code for manager sign-ups
    if (needsInviteCode) {
      if (!inviteCode.trim()) {
        setServerError('An invite code is required to create a manager account.')
        return
      }
